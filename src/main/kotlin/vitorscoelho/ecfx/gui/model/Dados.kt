...
class Dados {
    //Unidades
    val unitTensaoMaterialProperty: ObjectProperty<Unit<Pressure>> = SimpleObjectProperty(MEGAPASCAL)
    val unitModuloElasticidadeProperty: ObjectProperty<Unit<Pressure>> = SimpleObjectProperty(MEGAPASCAL)
    val unitAdimensionalProperty: ObjectProperty<Unit<Dimensionless>> = SimpleObjectProperty(ONE)
    val unitBitolaProperty: ObjectProperty<Unit<Length>> = SimpleObjectProperty(MILIMETRO)
    val unitCobrimentoProperty: ObjectProperty<Unit<Length>> = SimpleObjectProperty(CENTIMETRO)
    val unitDimensoesEstacaProperty: ObjectProperty<Unit<Length>> = SimpleObjectProperty(CENTIMETRO)
    ...
    val unitMomentoProperty: ObjectProperty<Unit<Moment>> =
        SimpleObjectProperty(QUILONEWTON.multiply(METRE).asType(Moment::class.java))
