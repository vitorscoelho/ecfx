...
//        ArrayList<StackedAreaChart.DataPointInfo<X, Y>> currentSeriesData = new ArrayList<>();
...
//        ArrayList<StackedAreaChart.DataPointInfo<X, Y>> aggregateData = new ArrayList<>();
...
//            for(StackedAreaChart.DataPointInfo<X, Y> data : currentSeriesData) {
//                data.partOf = StackedAreaChart.PartOf.PREVIOUS;
...
//                StackedAreaChart.DataPointInfo<X, Y> itemInfo = new StackedAreaChart.DataPointInfo<>(item, item.getXValue(),
//                        item.getYValue(), StackedAreaChart.PartOf.CURRENT);
...
//
//            for (StackedAreaChart.DataPointInfo<X, Y> dataInfo : aggregateData) {
...
//                if (dataInfo.partOf.equals(StackedAreaChart.PartOf.CURRENT)) { // handle data from current series
//                    int pIndex = findPreviousPrevious(aggregateData, dataIndex);
//                    int nIndex = findNextPrevious(aggregateData, dataIndex);
//                    StackedAreaChart.DataPointInfo<X, Y> prevPoint;
//                    StackedAreaChart.DataPointInfo<X, Y> nextPoint;
...
//                                StackedAreaChart.PartOf.CURRENT, false, (firstCurrent) ? false : true);
...
//                                addPoint(currentSeriesData, item, dataInfo.x, yAxis.toRealValue(yv), x, y, StackedAreaChart.PartOf.CURRENT, false,
...
//                                addPoint(currentSeriesData, item, dataInfo.x, yAxis.toRealValue(yValue + dataY), x, y, StackedAreaChart.PartOf.CURRENT, false,
//                                        (firstCurrent) ? false : true);
//                                if (dataIndex == lastCurrentIndex) {
//                                    // add drop down point
//                                    Data<X, Y> ddItem = new Data(dataInfo.x, dataY);
...
//                                    StackedAreaChart.PartOf.CURRENT, true, false);
//                        } else {
...
//                                double y = yAxis.getDisplayPosition(
//                                        yAxis.toRealValue(yv * seriesYAnimMultiplier.getValue()));
//                                addPoint(currentSeriesData, new Data(dataInfo.x, dataY), dataInfo.x, yAxis.toRealValue(yv), x, y, StackedAreaChart.PartOf.CURRENT, true, true);
//                            }
//                        }
//                    }
//                }
...
//            }
//            for (StackedAreaChart.DataPointInfo<X, Y> point : currentSeriesData) {
//                if (point.lineTo) {
...
//                StackedAreaChart.DataPointInfo<X, Y> point = aggregateData.get(i);
//                if (StackedAreaChart.PartOf.PREVIOUS.equals(point.partOf)) {
//                    fillPath.getElements().add(new  LineTo(point.displayX, point.displayY));
//                }
//            }
...
//    }
//
//    private void addDropDown(ArrayList<StackedAreaChart.DataPointInfo<X, Y>> currentSeriesData, Data<X, Y> item, X xValue, Y yValue, double x, double y) {
//        StackedAreaChart.DataPointInfo<X, Y> dropDownDataPoint = new StackedAreaChart.DataPointInfo<>(true);
//        dropDownDataPoint.setValues(item, xValue, yValue, x, y, StackedAreaChart.PartOf.CURRENT, true, false);
//        currentSeriesData.add(dropDownDataPoint);
//    }
//
//    private void addPoint(ArrayList<StackedAreaChart.DataPointInfo<X, Y>> currentSeriesData, Data<X, Y> item, X xValue, Y yValue, double x, double y, StackedAreaChart.PartOf partof,
//                          boolean symbol, boolean lineTo) {
//        StackedAreaChart.DataPointInfo<X, Y> currentDataPoint = new StackedAreaChart.DataPointInfo<>();
...
//    private int findNextCurrent(ArrayList<StackedAreaChart.DataPointInfo<X, Y>> points, int index) {
//        for(int i = index+1; i < points.size(); i++) {
//            if (points.get(i).partOf.equals(StackedAreaChart.PartOf.CURRENT)) {
//                return i;
//            }
//        }
//        return -1;
//    }
//
//    private int findPreviousCurrent(ArrayList<StackedAreaChart.DataPointInfo<X, Y>> points, int index) {
...
//
//
//    private int findPreviousPrevious(ArrayList<StackedAreaChart.DataPointInfo<X, Y>> points, int index) {
//        for(int i = index-1; i >= 0; i--) {
//            if (points.get(i).partOf.equals(StackedAreaChart.PartOf.PREVIOUS)) {
//                return i;
//            }
//        }
//        return -1;
//    }
//    private int findNextPrevious(ArrayList<StackedAreaChart.DataPointInfo<X, Y>> points, int index) {
//        for(int i = index+1; i < points.size(); i++) {
//            if (points.get(i).partOf.equals(StackedAreaChart.PartOf.PREVIOUS)) {
//                return i;
//            }
...
//
//
//    private void sortAggregateList(ArrayList<StackedAreaChart.DataPointInfo<X, Y>> aggregateList) {
...
//        DataPointInfo() {}
//
//        DataPointInfo(Data<X,Y> item, X x, Y y, StackedAreaChart.PartOf partOf) {
//            this.dataItem = item;
//            this.x = x;
//            this.y = y;
//            this.partOf = partOf;
...
//                       StackedAreaChart.PartOf partOf, boolean skipSymbol, boolean lineTo) {
//            this.dataItem = item;
//            this.x = x;
//            this.y = y;
//            this.displayX = dx;
